...
:: https://raw.githubusercontent.com/4coder-archive/4coder/master/custom/bin/setup_cl_generic.bat
:: https://web.archive.org/web/20240316212552/https://raw.githubusercontent.com/4coder-archi

:: Modifications: Added BuildTools for 2022
...
:: Modification: Added BuildTools Directory for 2022
SET VC_PATH=C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools
IF NOT DEFINED LIB (IF EXIST "%VC_PATH%" (call "%VC_PATH%\VC\Auxiliary\Build\vcvarsall.bat" %1))

SET VC_PATH=C:\Program Files\Microsoft Visual Studio\2022\BuildTools
IF NOT DEFINED LIB (IF EXIST "%VC_PATH%" (call "%VC_PATH%\VC\Auxiliary\Build\vcvarsall.bat" %1))